import StarshipsCards from '../components/Starships/Card';
		...
		<main className=" h-auto w-screen">
			<section className="mt-24  gap-10">
				<div className="flex font-star flex-col items-center text-center justify-center">
					...
					<h2 className="xl:text-4xl lg:text-2xl md:text-xl sm:text-xl inline-block font-bold text-white">Planets</h2>
				</div>
				<StarshipsCards />
			</section>
		</main>
